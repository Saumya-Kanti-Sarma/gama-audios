        ...
        <div className="content">
          ...
          <div className="about_contents">
            ...
            <div>
              ...
              <p>1. <b>Secure APIs:</b> We use  our own proprietary APIs for downloading your music and to save your data on our Server . This allows us to efficiently deliver content while maintaining robust security standards.
              </p>
              <p>2. <b>Your Data is Safe:</b>Your personal data is fully protected on our end. We do not share or sell your information to any third parties. Our systems are designed to respect your privacy and ensure that your data remains confidential.
              </p>
            </div>
            <div>
